...
$(document).ready(function  () {
    ...
    $("#valider").on('click', async function(){
        ...
        try {
            const request = await axios.post('/evaluation/module/valider');
            let response = request.data
            check = 1;
            enableButtons();
            Toast.fire({
    ...
    $("#devalider").on('click', async function(){
        ...
        try {
            const request = await axios.post('/evaluation/module/devalider');
            let response = request.data
            check = 0;
            enableButtons();
    ...
    $("#enregister").on('click', async function(){
        ...
        try {
            const request = await axios.post('/evaluation/module/enregistre');
            let response = request.data
            check = 0;
            enableButtons();
