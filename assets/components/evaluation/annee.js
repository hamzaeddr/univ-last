...
$(document).ready(function  () {
    ...
    $("#get_list_etudiant").on('click', async function(e){
        ...
        try {
            ...
            const request = await axios.post('/evaluation/annee/list/'+promotion_id, formData);
    ...
    $("#valider").on('click', async function(){
        ...
        try {
            const request = await axios.post('/evaluation/annee/valider');
            let response = request.data
            check = 1;
            enableButtons();
            Toast.fire({
    ...
    $("#devalider").on('click', async function(){
        ...
        try {
            const request = await axios.post('/evaluation/annee/devalider');
            let response = request.data
            check = 0;
            enableButtons();
    ...
    $("#enregister").on('click', async function(){
        ...
        try {
            const request = await axios.post('/evaluation/annee/enregistre');
            let response = request.data
            check = 0;
            enableButtons();
    ...
    $("#recalculer").on('click', async function(){
        ...
        try {
            const request = await axios.post('/evaluation/annee/recalculer');
            let response = request.data
    ...
    $("#statut_apres_rachat").on('click', async function() {
        ...
        try {
            const request = await axios.post('/evaluation/annee/statut/apresrachat');
            let response = request.data
    ...
    $("#statut_categorie").on('click', async function() {
        ...
        icon.removeClass('fa-sync').addClass("fa-spinner fa-spin");
        try {
            const request = await axios.post('/evaluation/annee/statut/statutanneecategorie');
            let response = request.data
            icon.addClass('fa-sync').removeClass("fa-spinner fa-spin");
            Toast.fire({
                icon: 'success',
